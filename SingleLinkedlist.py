...
class LinkedListApp:
    def __init__(self, root):
        ...
        self.position_label = tk.Label(root, text="Position (for insert at position):")
        ...
        self.insert_end_btn = tk.Button(root, text="Insert at End", command=self.insert_at_end)
        ...
        self.del_end_btn = tk.Button(root, text="Delete at End", command=self.delete_at_end)
        self.del_end_btn.pack()

        self.del_node_btn = tk.Button(root, text="Delete Node", command=self.delete_node)
        self.del_node_btn.pack()
    ...
    def display_list(self):
        elements = self.linked_list.traverse()
        self.output_label.config(text=" -> ".join(elements) + " -> None")
